    ...
    internal class Interfaz
    {
        ...
        public static int Menu()
        {
            string texto = "================================\n" +
                   ...
                   "================================\n";
            Console.Write(texto);
            return Calculo.getEntero("Ingrese una opción: ", texto);
        }
        public static int EncuestaVacuna()

        {
            string texto = " ================================\n" +
                ...
                "================================\n";
            Console.Write(texto);
            int EDAD = Calculo.getENTERO("¿Qué edad tienes: ");
            if (contador == 1000)
            {
            ...
            else
            {
                ...
                do
                {
                    VOTO = Calculo.getENTERO("Ingrese una opción: ");
            ...
            Console.Clear();
            return GraciasPorTuParticipación();
        }
        public static int GraciasPorTuParticipación()
        {
            string texto = " ================================\n" +
                "Encuesta de vacunación\n" +
                "================================\n" +
                ...
                "================================\n";
            Console.Write(texto);
            int opcion = Calculo.getEntero("Ingrese una opción: ", texto);
        ...
        public static int ResultadosFinales()
        {
            string texto = "================================\n" +
        ...
        public static int BuscarGente()
        {
            ...
            int valorBuscar = Calculo.getENTERO("¿Qué edad quieres buscar?: ");
            int vacunados = 0;
            int noVacunados = 0;
